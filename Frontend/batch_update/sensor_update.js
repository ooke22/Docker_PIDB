...
async function retrieveData() {
    ...
    try {
        ...
        const response = await fetch(`http://127.0.0.1:8000/batch-encoder/batch-detail/${batchLocation}/${batchID}/`, {
            method: 'GET',
            headers: {
...
async function updateElectrode() {
    ...
    try {
        ...
        const response = await fetch(`http://127.0.0.1:8000/batch-encoder/async/update-batch/${batchLocation}/${batchID}/`, {
            method: 'PUT',
            headers: {
        ...
        if(!response.ok) {
            ...
            notifications.info('Updates submitted.', { title: 'Batch Update'})
